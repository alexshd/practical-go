...
<!--
Finally, when all goroutines are done, verify the integrity of the file by comparing the MD5 digital signature of the downloaded file with the one from the `ETag` header.
...
<!--
- `crypto/md5` to calculate MD5 signature
-->
